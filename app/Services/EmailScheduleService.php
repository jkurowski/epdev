...
class EmailScheduleService
{
    ...
    public function addToSchedule(string $emailType, string $emailAddress, int $userId, string $scheduleDate, int $templateId, string $subject, string $content, string $action)
    {
