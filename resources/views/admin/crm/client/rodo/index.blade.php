        ...
        <div class="card-head container-fluid">
            <div class="row">
                <div class="col-6 pl-0">
                    <h4 class="page-title"><i class="fe-check-circle"></i>Klienci<span class="d-inline-flex me-2 ms-2">/</span>{{$client->name}}<span class="d-inline-flex me-2 ms-2">/</span>Zgody RODO</h4>
                </div>
                            ...
                            <table class="table mb-0" id="sortable">
                                ...
                                @foreach ($list as $p)
                                    <tr>
                                        ...
                                        <td class="small">
                                            @if ($p->activityLogs->isNotEmpty())
                                                @foreach ($p->activityLogs as $log)
