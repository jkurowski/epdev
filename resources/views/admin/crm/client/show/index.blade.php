                    ...
                    <form method="POST" action="{{ route('admin.crm.clients.update', $client) }}"
                        ...
                        <div data-company-fields class="company-fields w-100 mt-4">
                            <div id="collapseCompanyFields"
                                class="collapse {{ $client->is_company === 'on' ? 'show' : '' }}">
                                <div class="row w-100">
                                    <div class="col-6">
                                        @include('form-elements.html-input-text', [
                                            'label' => 'Nazwa firmy',
                            ...
                            <div class="row">
                                <div class="col-12 text-end">
                                    <input name="submit" id="submit" value="Zapisz" class="btn btn-primary"
                                        type="submit">
                                </div>
                            </div>
                    </form>
