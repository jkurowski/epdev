...
@section('content')
        ...
        <div class="card-head container-fluid">
            <div class="row">
                <div class="col-6 pl-0">
                    <h4 class="page-title"><i class="fe-book-open"></i>Footer</h4>
                </div>
                <div class="col-6 d-flex justify-content-end align-items-center form-group-submit">
                    <a href="{{route('admin.footer.create')}}" class="btn btn-primary">Dodaj moduł</a>
                </div>
            </div>
        </div>
        <div class="card mt-3">
                            ...
                            <tr id="recordsArray_{{ $item->id }}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{route('admin.footer.edit', $item->id)}}" class="btn action-button me-1" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Edytuj wpis"><i class="fe-edit"></i></a>
                                        <form method="POST" action="{{route('admin.footer.destroy', $item->id)}}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
    ...
    @push('scripts')
        <script>
            $(document).ready(function(){$("#sortable tbody.content").sortuj('{{route('admin.footer.sort')}}');});
