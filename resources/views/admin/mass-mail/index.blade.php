                    ...
                    <div class="row">
                            ...
                            <ul class="list-unstyled row">
                                ...
                                <li class='col-4'>
                                    <input class='d-none action-radio-input' type="radio" name="action"
                                        id="radio_upload_template" value='upload_template' data-bs-toggle='tab'
                                        data-bs-target='#upload_template_pane'>
                                    <label
                                        class='w-100 text-center border border-1 p-3 rounded h-100 d-flex align-items-center justify-content-center'
                                        for="radio_upload_template">Wgraj
                                        szablon</label>
                        ...
                        <div class='col-12 col-md-10 col-lg-8 col-xxl-6  offset-md-1 offset-lg-2 offset-xxl-3'>
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="col-5">
                                                <p class="text-end">
                                                    <a class="btn btn-primary w-100"
                                                        href="{{ route('admin.email.generator.create') }}">
                                                        <i class="fe-plus"></i>
                                                        Utwórz nowy szablon
                                                    </a>
                                                </p>
                                ...
                                <div class="tab-pane fade" id='upload_template_pane'>
                                    <div class="col-12">
                                        <div class="mb-5">
                                        ...
                                        <div>
                                            <input type="file" class="form-control" id="custom-html-template"
                                                accept=".zip">
                                        </div>
