            ...
            <div class="single-apartment-info">
                        ...
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16.481" height="16.481"
                                ...
                                <g transform="translate(0.4 0.4)">
                                    <path d="M25,8.011V2h9.67V12.192H31.795v5.488H29.443" transform="translate(-18.989 -2)"
                                        fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="0.8" />
                                    <path d="M11.67,24.238,10.1,25.806H2V13H8.011"
                    ...
                    <div class="d-flex">
                        ...
                        <div class="icon">
                            <svg id="layers" xmlns="http://www.w3.org/2000/svg" width="18.51" height="17.798"
                                ...
                                <g>
                                    <path d="M16.255,46.939a.3.3,0,0,1-.139-.035L7.151,42.011a.29.29,0,0,1,0-.509l8.966-4.893a.29.29,0,0,1,.277,0L25.359,41.5a.29.29,0,0,1,0,.509L16.393,46.9A.3.3,0,0,1,16.255,46.939ZM7.893,41.757l8.362,4.564,8.362-4.564-8.362-4.564Z"
                                        transform="translate(-7 -36.575)" />
                                </g>
                                <g transform="translate(0 6.75)">
                                    <path d="M16.255,604.064a.3.3,0,0,1-.139-.035l-5.56-3.034-3.406-1.858a.29.29,0,0,1,0-.508l3.406-1.858a.29.29,0,1,1,.277.508l-2.94,1.6,2.94,1.6,5.422,2.958,5.422-2.958,2.94-1.6-2.94-1.6a.29.29,0,1,1,.277-.508l3.406,1.858a.29.29,0,0,1,0,.508l-3.406,1.858-5.56,3.034A.282.282,0,0,1,16.255,604.064Z"
                                        transform="translate(-7 -596.734)" />
                                </g>
                                <g transform="translate(0 10.468)">
                                    <path d="M16.255,912.608a.3.3,0,0,1-.139-.035L7.151,907.68a.29.29,0,0,1,0-.509l3.406-1.858a.29.29,0,1,1,.277.509l-2.94,1.6,8.362,4.564,8.362-4.564-2.94-1.6a.29.29,0,1,1,.277-.509l3.406,1.858a.29.29,0,0,1,0,.509l-8.966,4.893A.3.3,0,0,1,16.255,912.608Z"
                ...
                @if ($property->terrace_area > 0)
                    <div class="box squares ">
                        ...
                        <div class="data">{{ $property->terrace_area }} m<sup>2</sup></div>
                    </div>
                    <div class="vr"></div>
                @endif
