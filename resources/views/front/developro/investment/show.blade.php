...
@section('content') 
    <x-breadcrumbs :items="[
        ['label' => 'Inwestycje', 'url' => route('front.developro.index')],
        ['label' => $investment->name, 'url' => route('front.developro.show', ['slug' => $investment->slug])],
    ]" />
                ...
                <div class="order-1 col-12 col-xl-6">
                    <div class="d-flex flex-column gap-4">
                        <div class="title-container">
                            <div class="header-1 aos-init aos-animate" data-aos="fade-up">Interesuje Cię <br>wykończenie pod
                                klucz?</div>
                        </div>
                        <div class="text-container d-flex flex-column gap-3">
                            <p class="text-pretty paragraph aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-xl-6">
                    <div class="d-flex flex-column gap-4">
                        ...
                        <div class="text-container d-flex flex-column gap-3">
                            <p class="text-pretty paragraph aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <strong>Dla naszych Klientów ubiegających się o&nbsp;kredyt hipoteczny oferujemy bezpłatne
                                    wsparcie ekspertów finansowych.</strong>
                            </p>
                            <p class="text-pretty paragraph aos-init" data-aos="fade-up" data-aos-delay="100">Doradcy pomogą
                            ...
                            <p class="text-pretty paragraph aos-init" data-aos="fade-up" data-aos-delay="100">Zapraszamy do
                                kontaktu</p>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-12 col-xl-6">
                    <div class="">
                        <picture>
                            <source srcset="/images/apartments/credit.webp" type="image/webp" media="(max-width: 992px)">
                            <source srcset="/images/apartments/credit@2x.webp" type="image/webp" media="(min-width: 992px)">
                            <source srcset="/images/apartments/credit.png" type="image/png" media="(max-width: 992px)">
                            <source srcset="/images/apartments/credit@2x.png" type="image/png" media="(min-width: 992px)">
