            ...
            <div class="collapse navbar-collapse justify-content-end bg-black position-relative" id="navbarNav">
                <ul class="navbar-nav fw-light py-4 py-xl-0 align-items-xl-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="{{ route('front.developro.index') }}">Mieszkania</a>
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($current_investment as $current_investment)
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('front.developro.show', $current_investment->slug) }}">
                                        {{ $current_investment->name }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pages.currently-for-sale') ? 'active' : '' }}"
                            href="{{ route('pages.currently-for-sale') }}">
                            Lokale Usługowe
                        </a>
                    </li>
